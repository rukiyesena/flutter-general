...
class NowUIColors {
  ...
  static const Color primary = Color.fromRGBO(233, 133, 52, 1.0);

  static const Color primaryWhite = Color.fromRGBO(255, 255, 237, 1.0);
  ...
  static const Color logoColor = Color.fromRGBO(115,103,240, 1.0);
}
